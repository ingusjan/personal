...
const Footer = () => {
  return (
    <div className='w-full text-sm mt-32 pt-4 pb-8 px-4 lg:px-32 xl:px-80 border-t  border-gray-800'>
      <div className='container mx-auto'>
        <p className='text-gray-500  text-gray-400'>
          © {dayjs().year()} Ingus Jansons
        </p>
        <p className='text-gray-500  text-gray-400 inline-flex align-center h=[32px]'>
          Built using
          {/* className='fill-current w-9 h-9 align-middle mr-4' */}
          <svg
            viewBox='0 0 237 176'
            className='fill-current w-12 h-8 -mt-px ml-3 mr-1'
          >
