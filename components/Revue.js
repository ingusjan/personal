    ...
    <div className='mt-8' id='revue-embed'>
      ...
      >
        <div>
          ...
          <input
            className='w-full block rounded-md px-3 py-2  bg-gray-800  text-gray-100'
        ...
        <div className='mt-5 lg:mt-0'>
          <label htmlFor='member_first_name'>
            First name{" "}
            <span className='text-gray-500  text-gray-400'>(Optional)</span>
          </label>
          <input
            className='w-full block rounded-md px-3 py-2  bg-gray-800  text-gray-100'
            type='text'
      ...
      <div className='mt-3 text-center lg:text-left text-xs text-gray-500  text-gray-400'>
        <p>
