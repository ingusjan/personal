const Projects = () => {
  ...
  return projects.map((p) => {
   ...
   <div className="mb-2 cursor-pointer transition hover:bg-gray-200 dark:hover:bg-gray-900 w-full p-5 border border-gray-300 dark:border-gray-800 flex flex-col lg:flex-row rounded-md">
        <div className="w-80 pb-2 lg:pb-0 lg:border-r border-gray-300 dark:border-gray-800">
          <p className="font-mono text-gray-400">name</p>
          {p.name}
        </div>
        <div className="lg:pl-7 pb-2 lg:pb-0 pt-2 lg:pt-0 w-80 border-t lg:border-t-0 lg:border-r border-gray-300 dark:border-gray-800">
