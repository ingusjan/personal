...
const Home = () => (
  <Container>
    ...
    <p className="prose prose-invert min-w-full my-5">
      Čau!👋 I'm Ingus, originally from Rīga, Latvia. I lead and scale Front-end
      Projects mainly using React, TypeScript & Monorepos. I also dabble in
      building my own SaaS tools for content creators.
    </p>
    ...
    <div className="flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-3">
      ...
      <p className="text-sm text-gray-500 md:hidden">{CONSULTATION_MESSAGE}</p>
    </div>
